...
| `st2_config`             | `{}`          | Hash with StackStorm configuration settings to set in [`st2.conf`](https://github.com/StackStorm/st2/blob/master/conf/st2.conf.sample) ini file. Including mongodb credentials here (under `st2_config.database`) will enable mongodb auth.
